...
def go(args):
    ...
    run = wandb.init(entity="rental_price", name="training_random_forest",
...
def plot_feature_importance(pipe, feat_names):
    """plot feature importance for a skleanr pipeline model pipe and feature names.

    Args:
        pipe (sklearn pipeline): sklearn model.
        feat_names (list): list of feature names.

    Returns:
        a figure for feature importance.
    """
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    """Construct an inference pipeline with sklearn."""
